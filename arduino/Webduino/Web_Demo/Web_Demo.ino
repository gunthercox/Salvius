...
void outputPins(WebServer &server, WebServer::ConnectionType type, bool addControls = true) {
  P(htmlHead) =
    "<html>"
    "<head>"
  ...
  if (true) {
    ...
    //server << "<input type='text' name='speech' value='' /><br/>";
    server << val;
    char pinName[4];
    server.textBox(pinName, "0", "Off", !val);
  }
